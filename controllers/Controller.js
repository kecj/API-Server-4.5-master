...
module.exports = class Controller {
  constructor(
    HttpContext,
    repository = null,
    needReadAuthorization = false,
    needWriteAuthorization = true
  ) {
      ...
      if (this.repository != null) {
        if (id !== undefined) {
          if (!isNaN(id)) {
            ...
            if (data != null) this.HttpContext.response.JSON(data);
            else this.HttpContext.response.notFound();
          } else this.HttpContext.response.badRequest();
        } else
  ...
  post(data) {
    if (this.writeAuthorization()) {
      if (this.repository != null) {
        ...
        if (data) {
          if (data.conflict) this.HttpContext.response.conflict();
          else this.HttpContext.response.created(data);
